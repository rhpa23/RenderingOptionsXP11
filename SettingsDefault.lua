...
function save_default_settings()
	...
	AURORA_BOREALIS=getDatai(findDataref("sim/private/controls/reno/draw_aurora"))
	CARRIERS_FRIGATES=getDatai(findDataref("sim/private/controls/reno/draw_boats"))
	BIRDS_DEER=getDatai(findDataref("sim/private/controls/reno/draw_deer_birds"))
	FIRES_BALOONS=getDatai(findDataref("sim/private/controls/reno/draw_fire_ball"))
	...
	RUNWAYS_CONTOURS=getDatai(findDataref("sim/private/controls/reno/sloped_runways"))
	ATMOSPHERIC_SCATTERING=getDataf(findDataref("sim/private/controls/reno/draw_scattering"))
	VOLUMETRIC_FOG=getDatai(findDataref("sim/private/controls/reno/draw_volume_fog01"))
	PIXEL_LIGHTING=getDatai(findDataref("sim/private/controls/reno/draw_per_pix_liting"))
	OBJECT_DENSITY=getDatai(findDataref("sim/private/controls/reno/draw_objs_06"))
	TRAFFIC_DENSITY=getDatai(findDataref("sim/private/controls/reno/draw_cars_05"))
	ROAD_DENSITY=getDatai(findDataref("sim/private/controls/reno/draw_vecs_03"))
	TAXIWAY_SMOOTHNESS=getDatai(findDataref("sim/private/controls/reno/draw_detail_apt_03"))
	FOREST_DENSITY=getDatai(findDataref("sim/private/controls/reno/draw_for_05"))
	...
	WATER_REFLECTION=getDatai(findDataref("sim/private/controls/reno/draw_reflect_water05"))
	COMPRESS_TEXTURES=getDatai(findDataref("sim/private/controls/reno/comp_texes"))
	BUMPMAP_TEXTURES=getDatai(findDataref("sim/private/controls/reno/use_bump_maps"))
	DETAIL_TEXTURES=getDatai(findDataref("sim/private/controls/reno/use_detail_textures"))
	...
	FFT_WATER=getDatai(findDataref("sim/private/controls/reno/draw_fft_water"))
	...
	HDR=getDatai(findDataref("sim/private/controls/reno/draw_HDR"))
